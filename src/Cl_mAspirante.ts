...
export default class Cl_mAspirante{
    ...
    set nota51(nt51: number){
        this.nota51 = nt51 > 0 && nt51 <= 25 ? nt51  : 0;
    }
    get nota51(): number {
        return this.nota51;
    }
    set nota52(nt52: number){
        this.nota52 = nt52 > 0 && nt52 <= 20 ? nt52  : 0;
    }
    get nota52(): number {
        return this.nota52;
    }
    set nota53(nt53: number){
        this.nota53 = nt53 > 0 && nt53 <= 6 ? nt53  : 0;
    }
    get nota53(): number {
        return this.nota53;
    }
    set nota54(nt54: number){
        this.nota51 = nt54 > 0 && nt54 <= 5 ? nt54  : 0;
    }
    get nota54(): number {
        return this.nota54;
    }
    set nota511(nt511: number){
        this.nota511 = nt511 > 0 && nt511 <= 25 ? nt511  : 0;
    }
    get nota511(): number {
        return this.nota511;
    }
    set nota512(nt512: number){
        this.nota512 = nt512 > 0 && nt512 <= 10 ? nt512  : 0;
    }
    get nota512(): number {
        return this.nota512;
    }
    set nota513(nt513: number){
        this.nota513 = nt513 > 0 && nt513 <= 3 ? nt513  : 0;
    }
    get nota513(): number {
        return this.nota513;
    }
    set nota514(nt514: number){
        this.nota514 = nt514 > 0 && nt514 <= 5 ? nt514  : 0;
    }
    get nota514(): number {
        return this.nota514;
    }
    set nota515(nt515: number){
        this.nota515 = nt515 > 0 && nt515 <= 3 ? nt515  : 0;
    }
    get nota515(): number {
        return this.nota515;
    }
    set nota516(nt516: number){
        this.nota516 = nt516 > 0 && nt516 <= 3 ? nt516  : 0;
    }
    get nota516(): number {
        return this.nota516;
    }
    set nota517(nt517: number){
        this.nota517 = nt517 > 0 && nt517 <= 3 ? nt517  : 0;
    }
    get nota517(): number {
        return this.nota517;
    }
